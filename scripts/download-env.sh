...
ln -sf $THIRD_DIR/litex/litex/soc/cores/cpu/lm32/verilog/config $THIRD_DIR/pythondata-cpu-lm32/pythondata_cpu_lm32/verilog/config
ln -sf $THIRD_DIR/litex/litex/soc/cores/cpu/lm32/verilog/config_lite $THIRD_DIR/pythondata-cpu-lm32/pythondata_cpu_lm32/verilog/config_lite
ln -sf $THIRD_DIR/litex/litex/soc/cores/cpu/lm32/verilog/config_minimal $THIRD_DIR/pythondata-cpu-lm32/pythondata_cpu_lm32/verilog/config_minimal
