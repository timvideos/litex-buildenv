...
_io = [
    ...
    ("dvi_out", 0,
        ...
        Subsignal("data2_n", Pins("Y12"), IOStandard("TMDS_33")),
        Subsignal("data1_p", Pins("AA10"), IOStandard("TMDS_33")),
        Subsignal("data1_n", Pins("AB10"), IOStandard("TMDS_33")),
        Subsignal("data0_p", Pins("Y9"), IOStandard("TMDS_33")),
        Subsignal("data0_n", Pins("AB9"), IOStandard("TMDS_33")),
    ...
    ("dvi_out", 1,
        ...
        Subsignal("data0_n", Pins("U13"), IOStandard("TMDS_33")),
