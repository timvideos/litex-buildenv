...
gateware-load-$(PLATFORM):
	@echo "Upduino_v1 doesn't support loading, use the flash target instead."
...
firmware-flash-$(PLATFORM):
	@echo "Upduino_v1 doesn't support just flashing firmware, use image target instead."
